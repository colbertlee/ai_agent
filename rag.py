...
def get_embedding_model(model_type="openai", api_key=None):
    ...
    if model_type == "openai":
        ...
        return ZhipuAIEmbeddings(api_key=key, model="embedding-2",
...
class RAGModule:
    def __init__(self, model, api_key=None, embedding_model_type=None):
        ...
        self.embeddings = get_embedding_model(self.embedding_model_type, api_key)
    ...
    def load_documents(self, file_paths):
        ...
        self.vectorstore = Chroma.from_documents(split_docs, self.embeddings, collection_name="knowledge_base")
    ...
    def query(self, question):
        return self.rag_chain.invoke(question) if self.rag_chain else "Load knowledge base first"
